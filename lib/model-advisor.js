...
const { capabilitiesFor, DEPTH_RANK, TOOLUSE_RANK } = require('./model-capabilities');
...
function requirementsFor(agent) {
  ...
  const reasoningDepth = tier === 'smart' ? 'complex' : 'moderate';
...
module.exports = { requirementsFor, assess, assessForTarget, adviseInstall };
